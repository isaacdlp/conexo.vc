if (window.pluginsAttached){alert("Attention! Script plugins.js library is connected twice and needs to be removed. The minified version already contains both of scripts.");}else{window.pluginsAttached=1;}
